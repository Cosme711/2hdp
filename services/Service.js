...
export default {
    getData() {
        return apiClient.get('/podcasts?_limit=10&_sort=date_publication:DESC')
    },
    loadMore(increment) {
        return apiClient.get('/podcasts?_start=' + increment + '&_limit=5&_sort=date_publication:DESC')
    }
  }
